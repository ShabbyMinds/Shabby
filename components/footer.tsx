    ...
    <footer className="relative bg-black border-t border-gray-800/50">
      ...
      <div className="relative z-10 border-b border-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            <h3 className="text-3xl sm:text-4xl font-bold text-white mb-4">Stay Updated with Tech Trends</h3>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Get exclusive insights, AI updates, and partnership opportunities delivered to your inbox.
            </p>
          </motion.div>
          ...
          >
            <div className="flex gap-4">
              ...
              <AnimatedButton type="submit" className="bg-red-600 text-white hover:bg-red-700">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center sm:text-left">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
                  <Mail className="h-5 w-5 text-red-500" />
                  <span>We are available 24/7 - Just mail us!</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-400 justify-center sm:justify-start">
              ...
              <div className="mt-8 flex flex-row gap-2 sm:gap-4">
                <Link href="/become-partner" className="flex-1">
                  <AnimatedButton className="w-full bg-red-600 text-white hover:bg-red-700 px-2 py-2 text-xs sm:px-4 sm:py-3 sm:text-base">
                    Explore
                  </AnimatedButton>
                </Link>
                <Link href="/faq" className="flex-1">
                  <AnimatedButton variant="outline" className="w-full border-gray-600 text-gray-300 hover:bg-gray-800 px-2 py-2 text-xs sm:px-4 sm:py-3 sm:text-base">
                    FAQ
                  </AnimatedButton>
                </Link>
              </div>
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-center sm:text-left">
            <p className="text-gray-500 text-sm">© {new Date().getFullYear()} ShabbyMinds. All rights reserved.</p>
            <div className="flex space-x-6 text-sm">
              <Link href="/privacy-policy" className="text-gray-500 hover:text-white transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms-conditions" className="text-gray-500 hover:text-white transition-colors">
                Terms of Service
              </Link>
